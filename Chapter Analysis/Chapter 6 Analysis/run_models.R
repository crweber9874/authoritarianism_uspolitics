...
# Some simple transofrmations
dat2000 <- data[[4]] %>% zap_labels()
dat2012 <- data[[5]] %>% zap_labels()
dat2016 <- data[[6]] %>% zap_labels()
...
save(dat, file = "~/Chapter 7 Analysis/chapter7_cohorts.rda")


### Voting, 2000
vote_2000 <- brm(
     vote2 ~ sex.2000 + age.2000 + college.2000 +
...
pid_2000 <- brm(
     pid3.2 ~ sex.2000 + age.2000 + college.2000 +
          income.2000 + authoritarianism + authoritarianism_2 +
...
vote_2012 <- brm(
     vote2 ~ sex.2012 + age.2012 + college.2012 +
...
pid__2012 <- brm(
     pid3.2 ~ sex.2012 + sex.2012 + college.2012 +
          income.2012 + authoritarianism + authoritarianism_2 +
          republican + independent +
          authoritarianism:republican +
          authoritarianism_2:republican +
...
vote_2016 <- brm(
     vote2 ~ female.2016 + age.2016 + college.2016 +
...
pid_2016 <- brm(
     pid3.2 ~ female.2016 + age.2016 + college.2016 +
          income.2016 + authoritarianism + authoritarianism_2 +
          republican + independent +
          authoritarianism:republican +
          authoritarianism_2:republican +
...
save(dat, file = "~Chapter 6 Analysis/chapter6.rda")
...
save(cohorts, file = "/Chapter 6 Analysis/chapter6_cohorts.rda")
