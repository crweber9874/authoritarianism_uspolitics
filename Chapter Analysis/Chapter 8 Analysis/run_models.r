...
distanceDem <- brm(
  differenceD1 ~ female + age + college + income + jewish +
    catholic + other + authoritarianism + authoritarianism2 + (1 + authoritarianism + authoritarianism2 | year),
  data = filteredData,
  chains = 3,
  cores = 8,
...
distanceDemEduc <- brm(
  differenceD1 ~ female + age + college + college *
...
distanceRep <- brm(
  differenceR1 ~ female + age + college + income + jewish +
    catholic + other + authoritarianism + authoritarianism2 + (1 + authoritarianism + authoritarianism2 | year),
  data = filteredData,
  chains = 3,
  cores = 10,
...
distanceRepEduc <- brm(
  differenceR1 ~ female + age + college + college *
    authoritarianism + authoritarianism2 + income + jewish +
    catholic + other + authoritarianism * college + authoritarianism2 * college + (1 + authoritarianism + authoritarianism2 + authoritarianism * college + authoritarianism2 * college | year),
  data = filteredData,
  chains = 3,
...
# Contour Figures
spatialModel <- brm(
  vote ~ authoritarianism + authoritarianism2 + diffOfdiff +
...
modelFitcollege <- brm(
  vote ~ authoritarianism + authoritarianism2 + college +
...
polarizationMod <- brm(
  vote ~ female + age + college + income + jewish +
